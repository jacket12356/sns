...
<head>
    ...
    <title>修改头像 - AESOPSNS - Powered By AESOPSNS</title>
    ...
    <script src="/Aesopsns/res/plugins/fullAvatarEditor/scripts/fullswfobject.js"></script>
    <script src="/Aesopsns/res/plugins/fullAvatarEditor/scripts/fullAvatar.js"></script>
</head>
            ...
            <div class="ibox-content">
                ...
                <script type="text/javascript">
                    swfobject.addDomLoadEvent(function () {
                        var swf = new fullAvatarEditor("/Aesopsns/res/plugins/fullAvatarEditor/fullAvatarEditor.swf", "/Aesopsns/res/plugins/fullAvatarEditor/expressInstall.swf", "swfContainer", {
                                    id: 'swf',
                                    upload_url: '/Aesopsns/user/iconupload',	//上传接口
