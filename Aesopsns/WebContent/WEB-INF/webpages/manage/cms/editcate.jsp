...
<head>
    ...
    <title>修改栏目 - ${SITE_NAME} - JEESNS后台管理系统 - Powered By JEESNS</title>
        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="${managePath}/cms/articleCate/update" class="jeesns_form">
                    <input type="hidden" class="form-control" id="id" name="cateid" value="${cate.cateid}">
                    <div class="form-group">
                        <label for="recipient-name" class="control-label">栏目名字:</label>
                        <input type="text" class="form-control" id="name" name="catename" data-type="require" alt="栏目名称"
                               value="${cate.catename}">
                    </div>
                    <div class="form-group">
